# investment-portfolio-sync Specification

## Purpose
Provide the read-only portfolio data foundation for FinOps: broker synchronization/import, normalized portfolio snapshot storage, source freshness metadata, import safety, and Wealthfolio display/export integration.
